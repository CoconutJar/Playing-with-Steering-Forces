// The "Vehicle" class
 ...
 class Vehicle {
  ...
  behaviors(good, bad){
    let foodSteer = this.eat(good, 0.3, this.dna[2]);
    let poisonSteer =  this.eat(bad, -0.4, this.dna[3]);
  ...
  clone(){
    if (random(1) < 0.008 && 0.5 < this.health){
      let child = new Vehicle(this.position.x, this.position.y);
